...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "testjhipsterMvn@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "testjhipsterMvn API";

        private String description = "testjhipsterMvn API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "testjhipsterMvn";
